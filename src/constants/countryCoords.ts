export const COUNTRY_COORDS: Record<string, {lat: number; lng: number}> = {
  ...
  "ET": { lat: 8.0, lng: 38.0 },
  "FK": { lat: -51.75, lng: -59.0 },
  "FO": { lat: 62.0, lng: -7.0 },
  "FJ": { lat: -18.0, lng: 175.0 },
  "FI": { lat: 64.0, lng: 26.0 },
  "FR": { lat: 46.0, lng: 2.0 },
  "GF": { lat: 4.0, lng: -53.0 },
  "PF": { lat: -15.0, lng: -140.0 },
  "TF": { lat: -43.0, lng: 67.0 },
  ...
  "TG": { lat: 8.0, lng: 1.1667 },
  "TK": { lat: -9.0, lng: -172.0 },
